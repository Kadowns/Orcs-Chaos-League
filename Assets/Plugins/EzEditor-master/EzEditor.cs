...
namespace EzEditor
{
    ...
    public class gui : Editor
    {
        ...
        public static void EzSpacer(float pixelsW, float pixelsH)
        {
            GUILayout.Label("", EditorStyles.label, MaxWidth(pixelsW), MinWidth(pixelsH));
        }
        ...
        public static AnimationCurve EzCurveField(string label, AnimationCurve curve, float offset = 0,
            params GUILayoutOption[] options) {
            AutosetFieldSize(label, offset);
            return EditorGUILayout.CurveField(label, curve, options);
        }
